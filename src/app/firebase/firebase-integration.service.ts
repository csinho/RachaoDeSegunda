...
export class FirebaseService {
  ...
  // Selecionar imagem do usuário modal
  ...
  /*
    Página de listagem de usuários do Firebase
  */
  ...
  public getListingStore(dataSource: Observable<Array<FirebaseListingItemModel>>): DataStore<Array<FirebaseListingItemModel>> {
    ...
    if (!this.listingDataStore) {
      // Inicialize o modelo especificando que é um modelo de shell
      ...
      //Disparar o mecanismo de carregamento (com shell) no dataStore
  ...
  */
  // Concat o userData com os detalhes do userSkills (da coleção de habilidades)
  ...
  */
  //Obter lista de todas as habilidades disponíveis (usadas nos modais de criação e atualização)
  ...
  // Obter dados de uma habilidade específica
